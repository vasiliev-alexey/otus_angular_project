...
import { setCurrency } from '../../../../header/store/currency.reducer';
...
export class BuyComponent {
  ...
  readonly buyForm = new FormGroup<BuyFormModel>({
  ...
  private _amountDescription: string = 'You can by 100' + this.selectedCurrency;
